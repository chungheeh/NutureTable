...
export const NutritionAnalysisPage: React.FC = () => {
  ...
  // 임시 데이터
  const weeklyData = [
    { day: '월', protein: 70, carbs: 220, fat: 60 },
    { day: '화', protein: 75, carbs: 240, fat: 65 },
    { day: '수', protein: 72, carbs: 230, fat: 62 },
    { day: '목', protein: 80, carbs: 250, fat: 68 },
    { day: '금', protein: 85, carbs: 260, fat: 70 },
    { day: '토', protein: 90, carbs: 270, fat: 75 },
    { day: '일', protein: 74, carbs: 235, fat: 64 },
  ];
